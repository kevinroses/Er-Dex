...
export const useAppStore = createStore<AppState>(
  (set, get) => ({
    ...
    initRaydiumAct: async (payload) => {
      ...
      const isDevnet = rpcNodeUrl === 'https://api.devnet.solana.com'
    ...
    fetchRpcsAct: async () => {
      ...
      try {
        ...
        // TODO: temporary code -- I used this temporary code for public rpc url
        let rpcs: RpcItem[] = [
          {
          ...
          {
            url: 'https://mainnet.helius-rpc.com/?api-key=173e8ba3-f079-46fc-9f2b-a4bf676a04c3',
            batch: true,
            name: 'Helius',
            weight: 10
          }
