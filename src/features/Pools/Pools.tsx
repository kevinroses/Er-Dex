...
export default function Pools() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      // Set or update timeBase once on client-side after hydration
      const clientTimeBase = Object.keys(FILED_KEY)[0] as TimeBase
      setTimeBase(clientTimeBase)
    }
  }, [])
  ...
  return (
    <>
      <Flex flexDirection="column" height="100vh" flexGrow={1} {...containerProps}>
        {/* Title Part */}
        <Box
          {...titleContainerProps}
          display={['block']}
          flexShrink={0}
          bg="var(--Glass-Card-Secondary)"
          border="1px solid"
        ...
        <Box marginX={revertAppLayoutPaddingX} mb={[0, 3]}>
          <Grid
            ...
            "time time create" auto / auto 1fr
            `
            ,`
              "tabs tabs  tabs" auto
          ...
          <Desktop>
            ...
            <GridItem area={'search'}>
              {/* Search Bar aligned to the start */}
            ...
            <FormControl display="flex" alignItems="center">
              <Tabs
                ...
                tabItemSX={{
                  ...
                  height: '32px',
                  _hover: {
                    backgroundColor: 'var(--Neutrals-Neutral-500)',
                    color: 'white',
                    cursor: 'pointer'
                  },
                  _selected: {
                    backgroundColor: 'var(--Neutrals-Neutral-600)',
                    color: 'white'
                  },
                  '&:not(:last-of-type)': {
                    borderRight: '1px solid var(--Neutrals-Neutral-500)'
                  }
                }}
              />
            </FormControl>
        ...
        <Box border="1px solid var(--Neutrals-Neutral-500)" borderTopRadius="12px">
          {/* Pool List Header with border */}
          ...
          {isNotFound ? (
            <Box
              ...
              alignItems="center"
              border="1px solid var(--Neutrals-Neutral-500)" // Added border here
            >
              <NotFound />
