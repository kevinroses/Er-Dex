...
export default function AddLiquidity({
  ...
  return (
    <Flex direction="column" w="full" px="24px" py="40px" bg={colors.backgroundTransparentNew} >
      {/* modal */}
      {/* <AutoSwapModal
      ...
      {/* quote token */}
      <Flex mt={10} justify="center" align="center" w={InputWidth} h="118px" borderRadius="12px">
        <TokenInput
          width="100%"
          ctrSx={{ w: '100%' }}
          topBlockSx={{ py: '6px' }}
