...
export default function CandleChart({ onPriceChange, baseMint, quoteMint, timeType, untilDate }: Props) {
  ...
  useEffect(() => {
    ...
    const upColor = '#A0FF41'
    const downColor = '#FF3737'
    ...
    const chart = createChart(chartCtrRef.current!, {
      ...
      leftPriceScale: { visible: true, borderColor: axisColor },
      timeScale: {
    ...
    chart.timeScale().applyOptions({
      rightOffset: 6, // Moves the view to focus more on the right side
      barSpacing: 20 // Adjust this value to zoom in or out; higher value means more zoomed-in
    })
