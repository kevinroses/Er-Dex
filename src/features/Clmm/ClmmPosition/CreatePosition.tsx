import { Box, Flex, Grid, GridItem, HStack, Tag, Text, useDisclosure, VStack } from '@chakra-ui/react'
    ...
    >
      ...
      <GridItem area={'chart-panel'}>
        ...
        `
          ...
          bg={colors.backgroundTransparentNew}
        >
          <GridItem gridArea={"chip"}>
            <Box>
              <VStack
                rounded="xl"
          ...
          <GridItem gridArea={'section-title'}>
            <Box fontWeight={500} color={colors.neutral300}>{t('clmm.set_price_range')}</Box>
          </GridItem>
