        ...
        <ModalBody>
          <Box>
            <Flex alignItems="center">
              ...
              {/* <TokenAvatarPair token1={undefined} token2={undefined} mr="2" /> */}
            ...
            >
              ...
              <Flex mt="2" alignItems="center" justifyContent="space-between">
                <Flex alignItems="center" gap="2">
                  ...
                  {/* <TokenAvatar size={'smi'} token={undefined} /> */}
                  {/* <Text variant="subTitle">{'symbolA'}</Text> */}
                </Flex>
              ...
              <Flex mt="2" justifyContent="space-between">
                ...
                {/* {formatToRawLocaleStr(toPercentString(isCreatePool ? 12 / 10000 : 12 * 100))} */}
              </Flex>
            </PanelCard>
                ...
                >
                  ...
                  <Text fontSize={['lg', 'xl']} fontWeight="500" color={colors.textPrimary}>
                    {price0Decimal > decimals
                      ...
                      : formatCurrency(new Decimal(priceRange[0]).toDecimalPlaces(12).toFixed(24), {
                ...
                >
                  ...
                  <Text fontSize={['lg', 'xl']} fontWeight="500" color={colors.textPrimary}>
                    {price1Decimal > 12
                      ...
                      : formatCurrency(new Decimal(priceRange[1]).toDecimalPlaces(12).toFixed(24), {
                          maximumDecimalTrailingZeroes: 5,
                          abbreviated: true
                        })}
                  </Text>
