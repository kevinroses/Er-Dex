...
export default function SetPriceAndRange({
  ...
  return (
    <Box display="flex" flexDir="column" p={[0, 0]}>
      <Desktop>
        <Flex mb={3} justifyContent="space-between" alignItems="center">
          <Text fontSize="xl" fontWeight="500" color="var(--Neutrals-Neutral-300)">
      ...
      <Desktop>
        ...
        <DecimalInput
          decimals={decimals}
          variant="neutral"
          ctrSx={{ bg: colors.neutral800, borderRadius: 'xl', px: '4px', py: ['2px', '6px'], border: "1px solid var(--Neutrals-Neutral-500)" }}
          inputGroupSx={{ bg: colors.neutral800, alignItems: 'center', borderRadius: 'xl' }}
          inputSx={{ pl: '4px', fontWeight: 500, fontSize: ['md', 'xl'], bg: colors.neutral800 }}
          postfix={
            <>
              <Desktop>
        ...
        <Flex alignItems="center" gap="1" sx={{ bg: colors.backgroundDark, alignItems: 'center', borderRadius: 'xl', p: '8px' }}>
          ...
          <Box flexGrow={1}>
            ...
            <HStack>
              ...
              />
              <Text variant="label" userSelect="none" width={"30%"}>
                {t('common.per_unit', {
