...
interface Props extends Required<TickData> {
  ...
  onConfirm: (props: { inputA: boolean; amount1: string; amount2: string; liquidity: BN | undefined }) => void
}

export default function TokenAmountPairInputs({ tempCreatedPool, baseIn, onConfirm, ...tickData }: Props) {
  console.log(tempCreatedPool)
      ...
      >
        ...
        <HStack justify={'space-between'}>
          ...
          <HStack fontWeight="500">
            ...
            <TokenAvatar token={undefined} size="sm" />
