...
export default function Initialize() {
  ...
  return (
    <VStack borderRadius="20px" w="full" bg="var(--modal-80)" border="1px solid var(--Neutrals-Neutral-500)" p={6} spacing={5}>
      {/* initial liquidity */}
      <Flex direction="column" w="full" align={'flex-start'} gap={4}>
        ...
        <Flex direction="column" w="full" align={'center'}>
          ...
          <Box display="flex" alignItems="center" width="100%">
            <Box flex="1" height="2px" bg="var(--Neutrals-Neutral-600)" me="10px" />

            {/* Wrapping the SVG in a Box to apply background */}
            <Box
              zIndex={1}
              p="10px"
            ...
            <Box flex="1" height="2px" bg="var(--Neutrals-Neutral-600)" ms="10px" />
          </Box>
      ...
      <Flex direction="column" w="full" gap={3}>
        ...
        <Tabs
          ...
          items={[
            {
              value: 'now',
              label: t('create_standard_pool.full_range')
            },
            {
              value: 'custom',
      ...
      <HStack w="full" spacing={4} mt={2}>
        <Button
          ...
          _hover={{
            bg: 'var(--button-primary)',
            _disabled: { bg: 'var(--button-primary)' }
          }}
          _focus={{ boxShadow: 'none' }}
          _active={{ bg: 'var(--button-primary)' }}
          _disabled={{
            bg: 'var(--button-primary) !important',
            color: 'white',
            cursor: 'not-allowed'
          }}
        >
