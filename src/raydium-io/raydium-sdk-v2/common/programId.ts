...
//modify
export const DEV_CREATE_CPMM_POOL_PROGRAM = new PublicKey('CPMDybc6GHgkKmWR6hFfxuYkUosCFK6Rt3uCkicYmJ1r')
export const DEV_CREATE_CPMM_POOL_AUTH = new PublicKey('8f1RWJ87SD7CREonLwrCxuzvEziid42R1WAsQx3DyJzT')
export const DEV_CREATE_CPMM_POOL_FEE_ACC = new PublicKey('BQuddgcQUuSnBEXNcyqiUPfUMMZVFoTGze4pKw3L4cPU')
...
export const DEVNET_PROGRAM_ID = {
  ...
  CLMM: new PublicKey('CLMDw9ZbZUDFJ7RNY47CueRftL8a5nkCixU2iDp11fU2'), //modify
