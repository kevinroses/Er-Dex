export const API_URLS = {
  BASE_HOST: process.env.NEXT_PUBLIC_BASE_HOST ?? 'https://api-v3.raydium.io',
  OWNER_BASE_HOST: process.env.NEXT_PUBLIC_OWNER_BASE_HOST ?? 'https://api-v3.raydium.io',
  SERVICE_BASE_HOST: process.env.NEXT_PUBLIC_SERVICE_BASE_HOST ?? 'https://api-v3.raydium.io',
  MONITOR_BASE_HOST: process.env.NEXT_PUBLIC_MONITOR_BASE_HOST ?? 'https://api-v3.raydium.io',
  // SERVICE_1_BASE_HOST: "https://service-v1.raydium.io",
  SERVICE_1_BASE_HOST: 'http://localhost:3000',
  ...
  SWAP_HOST: process.env.NEXT_PUBLIC_SWAP_HOST ?? 'https://transaction-v1.raydium.io',
